## 6 - Install SubCA2 (Lab Issuing CA 2) - PART 2 (YubiHSM 2 Edition)
...
Start-Transcript -Path (Join-Path $LogDir "PKILab-6a-Subca2-Install-Part2.log") -Append -ErrorAction SilentlyContinue
