<#
.SYNOPSIS
    PKI Lab - WEB1 Certificate Enrollment for Enroll/SCEP1 SSL

.DESCRIPTION
    Automates certificate request, issuance, installation, and validation for WEB1.
    
    SANs included:
    - enroll.lab.local (DNS round-robin)
    - scep1.lab.local  (WEB1 only)
