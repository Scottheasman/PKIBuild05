## 6 - Install SubCA2 (Lab Issuing CA 2) - PART 1
...
Write-Host "SubCA2 role installed and request generated." -ForegroundColor Green
...
Write-Host "   Action: Once the file is back on SubCA2, run the 'ApplyIssuedCert' script." -ForegroundColor Yellow
Write-Host ""
Write-Host "====" -ForegroundColor Red
