## 6 - Install SubCA1 (Lab Issuing CA 1) - PART 1 (YubiHSM 2 Edition)
...
### PRE-REQUISITE: YubiHSM stick for SubCA1 must be inserted and connector service running.
...
Write-Host "SubCA1 role installed and request generated on YubiHSM." -ForegroundColor Green
...
Write-Host "   Action: Once the file is back on SubCA1, run the Part 2 script." -ForegroundColor Yellow
Write-Host ""
Write-Host "====" -ForegroundColor Red
